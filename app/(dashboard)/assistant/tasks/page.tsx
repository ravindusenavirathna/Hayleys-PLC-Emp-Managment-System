...
export const metadata: Metadata = { title: "Assigned Tasks — Coming Soon" };

export default async function AssistantTasksComingSoonPage() {
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-4 text-center px-4">
      ...
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-slate-800">
          Assigned Tasks Under Construction
        </h1>
