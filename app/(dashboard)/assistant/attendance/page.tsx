...
export const metadata: Metadata = { title: "Attendance — Coming Soon" };

export default async function AttendanceComingSoonPage() {
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-4 text-center px-4">
      ...
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-slate-800">
          Attendance Management Under Construction
        </h1>
