...
export const metadata: Metadata = { title: "Borrow Workers — Coming Soon" };

export default async function BorrowWorkersComingSoonPage() {
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-4 text-center px-4">
      ...
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-slate-800">
          Borrow Workers Under Construction
        </h1>
