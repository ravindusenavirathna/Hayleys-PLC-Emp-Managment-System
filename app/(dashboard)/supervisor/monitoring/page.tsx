...
export const metadata: Metadata = { title: "Task Monitoring — Coming Soon" };

export default async function MonitoringComingSoonPage() {
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-4 text-center px-4">
      ...
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-slate-800">
          Task Monitoring Under Construction
        </h1>
