...
export default async function TaskDetailPage({ params }: PageProps) {
  ...
  // Check role restriction: Team leader can only view tasks of their own warehouse
  if (user.role.name === "team_leader" && task.warehouseId !== user.warehouseId) {
    redirect("/team-leader/tasks");
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <Link
          href={user.role.name === "admin" ? "/admin/tasks" : "/team-leader/tasks"}
